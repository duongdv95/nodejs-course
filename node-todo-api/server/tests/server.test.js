...
describe("GET /todos/:id", () => {
    ...
    it("should not return todo do created by other user", (done) => {
        request(app)
...
describe("POST /users", () => {
    ...
    it("should return validation errors if request invalid", (done) => {
        // send invalid email and invalid password and expect 400
        var email = "asdfasdfa";
        var password = "";
    ...
    it("should not create user if email in use", (done) => {
        // use email thats already taken in seed data expect 400
        var email = "daniel@duong.com";
        var password = "adsfasd";
...
describe("POST /users/login", () => {
    ...
    it("should reject invalid login", (done) => {
        // 400, xauth token not exist, user tokenarray length = 0,
        request(app)
            .post("/users/login")
            .send({
                email: users[1].email,
